...
function getCurrencyConversionRate(fromCurrency, toCurrency) {
    ...
    $.ajax({
        ...
        error: function(data) {
            alert('There was a problem converting currencies!');
        }
    });
}
...
$(document).ready(function() {
    ...
    $("#checkButton").click(function() {
        ...
        var fromCurrency = $('#dropdownFromButton').text();
        var toCurrency = $('#dropdownToButton').text();

        getCurrencyConversionRate(fromCurrency, toCurrency);
    });
});
